...
public class GangWaypointPayload {
    public static final Identifier CREATE_POS = Pathfinder.identifier("create_gang_pos_waypoint");
    public static final Identifier CREATE_ENTITY = Pathfinder.identifier("create_gang_entity_waypoint");
    public static final Identifier REMOVE = Pathfinder.identifier("remove_gang_waypoint");
